...
const helpContent = {
  shellType: {
    header: '烟花类型',
    body: '将发射的烟花类型。选择“随机”以获得不错的分类！',
  },
  shellSize: {
    header: '烟花大小',
    body: '烟花的大小。仿照真实的烟花炮弹尺寸，更大的炮弹有更大的爆发，有更多的星星，有时效果更复杂。然而，更大的炮弹也需要更多的处理能力，可能会导致延迟。',
  },
  quality: {
    header: '烟花质量',
    body: '整体图形质量。如果动画运行不流畅，请尝试降低质量。高质量大大增加了渲染的火花量，并可能导致延迟。',
  },
  skyLighting: {
    header: '天空照明',
  ...
  scaleFactor: {
    header: '烟花规模',
    body: '允许缩放所有烟花的大小，基本上将您移动得更近或更远。对于更大的外壳尺寸，可以方便地稍微缩小比例，尤其是在手机或平板电脑上。',
  },
  autoLaunch: {
    header: '自动发射',
    body: '自动发射烟花序列。坐下来享受表演，或禁用以完全控制。',
  },
  finaleMode: {
    header: '发射密集的烟花',
    body: '发射密集的烟花。可能会导致延迟。需要启用“自动开火”。',
  },
  hideControls: {
    header: '隐藏控制',
    body: '沿屏幕顶部隐藏半透明控件。对于屏幕截图很有用，或者只是更无缝的体验。隐藏时，您仍然可以点击右上角重新打开此菜单。',
  },
  fullscreen: {
    header: '全屏',
    body: '切换全屏模式。',
...
function init() {
  ...
  setOptionsForSelect(appNodes.quality, [
    ...
    { label: '默认', value: QUALITY_NORMAL },
    { label: '普通', value: QUALITY_HIGH },
  ])

  setOptionsForSelect(appNodes.skyLighting, [
    { label: '无', value: SKY_LIGHT_NONE },
    { label: '昏暗', value: SKY_LIGHT_DIM },
    { label: '默认', value: SKY_LIGHT_NORMAL },
  ])
